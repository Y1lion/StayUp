...
background: linear-gradient(229deg, rgba(34,193,195,1) 0%, rgba(23,137,181,1) 70%, rgba(23,137,181,1) 100%);border-radius: 5px 0 0 5px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <p class="h5 mt-2">Welcome in your Login page, User! We're happy to see you again. It's always a pleasure to have you back here.</p>
            <button class="btn mt-4 btn-primary align-self-center shadow rounded-pill w-75">New to the platform? Sign up!</button>
        </div>
        <div id="divSignIn" class="col-lg-4 col-sm-4 d-flex flex-column bg-light h-100 p-4 align-items-center" style="border-radius:0 5px 5px 0;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);color:black">
            ...
            <form>
                <input type="email" style="margin-top:20px" class="form-control" required placeholder="Email">
                <input type="password" style="margin-top:15px" class="form-control"  required placeholder="Password">

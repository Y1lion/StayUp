...
public class UserBeanDAO {
    ...
    public synchronized UserBean UserRegistration(String email, String password, String name, String surname,String telephone){
        Connection conn =  null;
        PreparedStatement ps = null;
        ...
        try {
            ...
            conn = ConnectionPool.getConnection();
            String sqlString = new String("INSERT INTO user(email,password,name,surname,telephone) VALUES(?,?,?,?,?)");

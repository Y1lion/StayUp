...
class ServletChangeEmailTest {
    ...
    @InjectMocks
    private ServletChangeEmail servlet;
    ...
    static void removeRegisteredUser(){
        new UserBeanDAO().deleteUser("testing@gmail.org");
    }

    @Test
    void doPostTrue() throws ServletException, IOException {
        when(request.getParameter("newemail")).thenReturn("testing@gmail.org");
        when(request.getParameter("current_password")).thenReturn("Ciaoprova1@");
    ...
    @Test
    void doPostEmailFormatInvalid() throws ServletException, IOException {
        when(request.getParameter("newemail")).thenReturn("t@@");
        when(request.getParameter("current_password")).thenReturn("Ciaoprova1@");
        when(session.getAttribute("email")).thenReturn("testing@testing.org");
    ...
    void doPostPasswordInvalid() throws ServletException, IOException {
        when(request.getParameter("newemail")).thenReturn("testing@gmail.org");
        when(request.getParameter("current_password")).thenReturn("Ciaoprova");
        when(session.getAttribute("email")).thenReturn("testing@testing.org");

...
class ServletChangeGenderTest {
    ...
    @InjectMocks
    private ServletChangeGender servlet;
    ...
    void doPostTrue() throws ServletException, IOException {
        ...
        when(request.getParameter("current_password2")).thenReturn("Ciaoprova1@");
    ...
    @Test
    void doPostGenderNotSelected() throws ServletException, IOException {
    ...
    void doPostPasswordInvalid() throws ServletException, IOException {
        when(request.getParameter("gender")).thenReturn(null);
        when(request.getParameter("current_password2")).thenReturn("Ciaoprova");
        when(session.getAttribute("email")).thenReturn("testing@testing.org");
